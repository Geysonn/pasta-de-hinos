...
Deus vai me ajudar (2x)`}],geracaoLife:[]};async function br(e){return[...yr[e]].sort((e,t)=>e.number-t.number)}async function xr(e,t){return yr[e].find(e=>e.id===t)}var Sr={harpa:`Harpa Cristã`,preciosas:`Preciosas`,geracaoLife:`Geração Life`},Cr={harpa:`Pasta a cadastrar`,preciosas:`Círculo de Oração · JD América`,geracaoLife:`Pasta a cadastrar`},wr={harpa:`🎵`,preciosas:`💎`,geracaoLife:`🔥`},Tr={preciosas:`./preciosas-logo.jpg`},Er={harpa:`harpa`,preciosas:`preciosas`,geracaoLife:`geracao-life`},Dr=[`preciosas`,`harpa`,`geracaoLife`];function Or(){let[e,t]=(0,x.useState)({});return(0,x.useEffect)(()=>{let e=!0;return Promise.all(Dr.map(e=>br(e))).then(n=>{if(!e)return;let r={};Dr.forEach((e,t)=>{r[e]=n[t].length}),t(r)}),()=>{e=!1}},[]),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(vr,{title:`Hinos`,subtitle:`Toque numa pasta para abrir`}),(0,j.jsx)(`div`,{className:`flex flex-col gap-3 px-4 pb-4 pt-2`,children:Dr.map(t=>{let n=e[t],r=n===0;return(0,j.jsxs)(jn,{to:`/${Er[t]}`,className:`flex items-center gap-3 rounded-2xl bg-surface px-4 py-4 transition active:scale-[0.98]`,children:[Tr[t]?(0,j.jsx)(`img`,{src:Tr[t],alt:``,"aria-hidden":!0,className:`h-12 w-12 shrink-0 rounded-xl object-cover`}):(0,j.jsx)(`span`,{className:`flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-primary-soft text-2xl`,"aria-hidden":!0,children:wr[t]}),(0,j.jsxs)(`div`,{className:`min-w-0 flex-1`,children:[(0,j.jsx)(`p`,{className:`truncate font-semibold text-text`,children:Sr[t]}),(0,j.jsx)(`p`,{className:`truncate text-xs text-text-muted`,children:Cr[t]})]}),(0,j.jsx)(`span`,{className:`shrink-0 text-xs font-medium text-text-muted`,children:n===void 0?`…`:r?`em breve`:`${n} hinos`}),(0,j.jsx)(`span`,{className:`text-text-muted`,children:`›`})]},t)})})]})}function kr({value:e,onChange:t,placeholder:n=`Pesquisar…`}){return(0,j.jsxs)(`div`,{className:`flex items-center gap-2 rounded-full bg-surface px-4 py-3`,children:[(0,j.jsx)(`span`,{"aria-hidden":!0,className:`text-text-muted`,children:`🔎`}),(0,j.jsx)(`input`,{value:e,onChange:e=>t(e.target.value),placeholder:n,className:`w-full bg-transparent text-sm text-text placeholder:text-text-muted focus:outline-none`}),e&&(0,j.jsx)(`button`,{onClick:()=>t(``),"aria-label":`Limpar busca`,className:`text-text-muted hover:text-text`,children:`✕`})]})}function Ar({rows:e=4}){return(0,j.jsx)(`div`,{className:`flex flex-col gap-3 px-4 py-4`,"aria-busy":`true`,"aria-label":`Carregando`,children:Array.from({length:e}).map((e,t)=>(0,j.jsx)(`div`,{className:`h-24 w-full animate-pulse rounded-2xl bg-surface-alt`},t))})}function jr(){return(0,j.jsx)(`div`,{className:`flex items-center justify-center py-16`,"aria-busy":`true`,"aria-label":`Carregando`,children:(0,j.jsx)(`div`,{className:`h-8 w-8 animate-spin rounded-full border-2 border-border border-t-primary`})})}function Mr({title:e=`Não foi possível carregar o conteúdo`,description:t=`Verifique sua conexão e tente novamente.`,onRetry:n}){return(0,j.jsxs)(`div`,{className:`flex flex-col items-center justify-center gap-3 px-6 py-16 text-center`,children:[(0,j.jsx)(`span`,{className:`text-4xl`,"aria-hidden":!0,children:`⚠️`}),(0,j.jsx)(`p`,{className:`font-medium text-text`,children:e}),(0,j.jsx)(`p`,{className:`text-sm text-text-muted max-w-xs`,children:t}),n&&(0,j.jsx)(`button`,{onClick:n,className:`mt-2 rounded-full bg-primary px-5 py-2 text-sm font-medium text-white active:scale-95 transition`,children:`Tentar novamente`})]})}function Nr({icon:e=`📭`,title:t,description:n}){return(0,j.jsxs)(`div`,{className:`flex flex-col items-center justify-center gap-2 px-6 py-16 text-center`,children:[(0,j.jsx)(`span`,{className:`text-4xl`,"aria-hidden":!0,children:e}),(0,j.jsx)(`p`,{className:`font-medium text-text`,children:t}),n&&(0,j.jsx)(`p`,{className:`text-sm text-text-muted max-w-xs`,children:n})]})}var Pr=Jn()(Zn((e,t)=>({hymnFavorites:[],toggleHymnFavorite:t=>e(e=>({hymnFavorites:e.hymnFavorites.includes(t)?e.hymnFavorites.filter(e=>e!==t):[...e.hymnFavorites,t]})),isHymnFavorite:e=>t().hymnFavorites.includes(e),verseFavorites:[],toggleVerseFavorite:t=>e(e=>({verseFavorites:e.verseFavorites.includes(t)?e.verseFavorites.filter(e=>e!==t):[...e.verseFavorites,t]})),isVerseFavorite:e=>t().verseFavorites.includes(e)}),{name:`adba-app-favorites`}));function Fr({hymnalId:e,basePath:t}){let{data:n,loading:r,error:i,reload:a}=ir(()=>br(e),[e]),[o,s]=(0,x.useState)(``),{isHymnFavorite:c}=Pr(),l=(0,x.useMemo)(()=>{if(!n)return[];let e=o.trim().toLowerCase();return e?n.filter(t=>t.title.toLowerCase().includes(e)||String(t.number).includes(e)):n},[n,o]);return(0,j.jsxs)(`div`,{children:[(0,j.jsx)(vr,{title:Sr[e],showBack:!0,onBack:()=>history.back()}),(0,j.jsx)(`div`,{className:`px-4 pt-4`,children:(0,j.jsx)(kr,{value:o,onChange:s,placeholder:`Buscar por número ou título…`})}),(0,j.jsxs)(`div`,{className:`px-4 py-4`,children:[r&&(0,j.jsx)(Ar,{}),i&&(0,j.jsx)(Mr,{onRetry:a}),n&&l.length===0&&(0,j.jsx)(Nr,{icon:`🎵`,title:`Nenhum hino encontrado`}),(0,j.jsx)(`div`,{className:`flex flex-col gap-2`,children:l.map(e=>(0,j.jsxs)(jn,{to:`${t}/${e.id}`,className:`flex items-center gap-3 rounded-2xl bg-surface px-3 py-3 transition active:scale-[0.98]`,children:[(0,j.jsx)(`span`,{className:`flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-primary-soft text-sm font-bold text-primary`,children:e.number}),(0,j.jsx)(`span`,{className:`flex-1 text-sm font-medium text-text`,children:e.title}),c(e.id)&&(0,j.jsx)(`span`,{"aria-hidden":!0,children:`★`})]},e.id))})]})]})}function Ir({lyrics:e}){let t=e.split(`**`);return(0,j.jsx)(j.Fragment,{children:t.map((e,t)=>t%2==1?(0,j.jsx)(`strong`,{className:`font-bold`,children:e},t):(0,j.jsx)(`span`,{children:e},t))})}function Lr({hymnalId:e,basePath:t}){let{id:n}=bt(),r=gt(),{data:i,loading:a,error:o}=ir(()=>xr(e,n),[e,n]),{data:s}=ir(()=>br(e),[e]),c=Qn(e=>e.fontScale),l=Qn(e=>e.setFontScale),{isHymnFavorite:u,toggleHymnFavorite:d}=Pr(),[f,p]=(0,x.useState)(!1),m=s&&i?s.findIndex(e=>e.id===i.id):-1,h=s&&m>0?s[m-1]:null,g=s&&m>=0&&m<s.length-1?s[m+1]:null;return(0,j.jsxs)(`div`,{className:`pb-28`,children:[(0,j.jsxs)(`div`,{className:`sticky top-0 z-30 flex items-center gap-2 bg-bg px-4 pb-2 pt-4`,children:[(0,j.jsx)(`button`,{onClick:()=>r(t),"aria-label":`Voltar`,className:`flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-surface text-text active:scale-95`,children:`←`}),(0,j.jsxs)(`div`,{className:`flex flex-1 gap-2`,children:[(0,j.jsx)(`button`,{onClick:()=>l(c-.1),className:`h-9 w-9 rounded-full bg-surface text-sm text-text active:scale-95`,children:`A-`}),(0,j.jsx)(`button`,{onClick:()=>l(c+.1),className:`h-9 w-9 rounded-full bg-surface text-sm text-text active:scale-95`,children:`A+`})]}),i&&(0,j.jsx)(`button`,{onClick:()=>d(i.id),"aria-label":`Favoritar`,className:`flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-surface text-lg active:scale-95`,children:u(i.id)?`★`:`☆`})]}),a&&(0,j.jsx)(jr,{}),o&&(0,j.jsx)(Mr,{}),i&&(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(`div`,{className:`px-4 py-2 text-center`,children:[(0,j.jsx)(`p`,{className:`text-xs font-semibold uppercase tracking-widest text-text-muted`,children:Sr[e]}),(0,j.jsx)(`p`,{className:`text-6xl font-black leading-none text-text`,children:i.number}),(0,j.jsx)(`h1`,{className:`mt-2 text-xl font-bold leading-snug text-text`,children:i.title})]}),(0,j.jsx)(`div`,{className:`px-4`,children:(0,j.jsx)(`p`,{className:`whitespace-pre-line leading-relaxed text-text`,style:{fontSize:`${c}rem`},children:(0,j.jsx)(Ir,{lyrics:i.lyrics})})}),(0,j.jsx)(`div`,{className:`fixed bottom-16 left-0 right-0 z-30 mx-auto max-w-md px-4 pb-3`,children:f?(0,j.jsx)(`div`,{className:`flex items-center justify-center rounded-2xl border border-border bg-surface py-2 shadow-lg`,children:(0,j.jsxs)(`button`,{onClick:()=>{mr({title:i.title,text:i.lyrics.replace(/\*\*/g,``),url:location.href}),p(!1)},className:`flex flex-col items-center gap-0.5 px-4 text-[11px] font-medium text-text active:scale-95`,children:[(0,j.jsx)(`span`,{className:`text-lg`,children:`📤`}),`Compartilhar`]})}):(0,j.jsxs)(`div`,{className:`flex items-center gap-1 rounded-full border border-border bg-surface p-1.5 shadow-lg`,children:[h?(0,j.jsx)(jn,{to:`${t}/${h.id}`,className:`flex h-9 w-9 items-center justify-center rounded-full text-text active:scale-95`,"aria-label":`Hino anterior`,children:`‹`}):(0,j.jsx)(`span`,{className:`h-9 w-9`}),(0,j.jsxs)(`button`,{onClick:()=>p(!0),className:`flex-1 truncate rounded-full py-2 text-center text-sm font-medium text-text`,children:[`Hino `,i.number]}),g?(0,j.jsx)(jn,{to:`${t}/${g.id}`,className:`flex h-9 w-9 items-center justify-center rounded-full text-text active:scale-95`,"aria-label":`Próximo hino`,children:`›`}):(0,j.jsx)(`span`,{className:`h-9 w-9`})]})})]})]})}function Rr(){let{hymnFavorites:e,verseFavorites:t}=Pr(),[n,r]=(0,x.useState)(null),[i,a]=(0,x.useState)(null);(0,x.useEffect)(()=>{let t=!0;return Promise.all(Dr.map(e=>br(e))).then(n=>{if(!t)return;let i=n.flat();r(i.filter(t=>e.includes(t.id)))}),()=>{t=!1}},[e]),(0,x.useEffect)(()=>{let e=!0;return Promise.all(t.map(async e=>{let[t,n,r]=e.split(`-`),i=Number(n),a=Number(r);return{key:e,book:t,chapter:i,verse:a,text:(await cr(t,i))[a-1]??``}})).then(t=>{e&&a(t)}),()=>{e=!1}},[t]);let o=n!==null&&n.length===0&&i!==null&&i.length===0;return(0,j.jsxs)(`div`,{children:[(0,j.jsx)(vr,{title:`Favoritos`,subtitle:`Hinos e versículos marcados`}),(0,j.jsxs)(`div`,{className:`px-4 py-4`,children:[(n===null||i===null)&&(0,j.jsx)(Ar,{}),o&&(0,j.jsx)(Nr,{icon:`⭐`,title:`Nenhum favorito ainda`,description:`Marque um hino ou versículo para guardá-lo aqui.`}),i&&i.length>0&&(0,j.jsxs)(`div`,{className:`mb-6`,children:[(0,j.jsx)(`p`,{className:`mb-2 px-1 text-xs font-semibold uppercase tracking-wide text-text-muted`,children:`Versículos`}),(0,j.jsx)(`div`,{className:`flex flex-col gap-2`,children:i.map(e=>(0,j.jsxs)(jn,{to:`/biblia/${e.book}/${e.chapter}`,className:`rounded-2xl bg-surface px-4 py-3 transition active:scale-[0.98]`,children:[(0,j.jsx)(`p`,{className:`line-clamp-2 text-sm text-text`,children:e.text}),(0,j.jsxs)(`p`,{className:`mt-1 text-xs font-medium text-primary`,children:[ur[e.book]?.name,` `,e.chapter,`:`,e.verse]})]},e.key))})]}),n&&n.length>0&&(0,j.jsxs)(`div`,{children:[(0,j.jsx)(`p`,{className:`mb-2 px-1 text-xs font-semibold uppercase tracking-wide text-text-muted`,children:`Hinos`}),(0,j.jsx)(`div`,{className:`flex flex-col gap-2`,children:n.map(e=>(0,j.jsxs)(jn,{to:`/${Er[e.hymnal]}/${e.id}`,className:`flex items-center gap-3 rounded-2xl bg-surface px-3 py-3 transition active:scale-[0.98]`,children:[(0,j.jsx)(`span`,{className:`flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-primary-soft text-sm font-bold text-primary`,children:e.number}),(0,j.jsxs)(`div`,{className:`min-w-0 flex-1`,children:[(0,j.jsx)(`p`,{className:`truncate text-sm font-medium text-text`,children:e.title}),(0,j.jsx)(`p`,{className:`truncate text-xs text-text-muted`,children:Sr[e.hymnal]})]}),(0,j.jsx)(`span`,{"aria-hidden":!0,children:`★`})]},e.id))})]})]})]})}var zr=[{value:`light`,label:`Claro`},{value:`dark`,label:`Escuro`},{value:`system`,label:`Seguir sistema`}];function Br(){let e=Qn(e=>e.theme),t=Qn(e=>e.setTheme),n=Qn(e=>e.fontScale),r=Qn(e=>e.setFontScale);return(0,j.jsxs)(`div`,{children:[(0,j.jsx)(vr,{title:`Configurações`}),(0,j.jsxs)(`div`,{className:`px-4 py-4`,children:[(0,j.jsx)(`h2`,{className:`mb-2 text-sm font-semibold text-text-muted`,children:`Tema`}),(0,j.jsx)(`div`,{className:`flex gap-2`,children:zr.map(n=>(0,j.jsx)(`button`,{onClick:()=>t(n.value),className:`flex-1 rounded-full py-2.5 text-sm font-medium transition ${e===n.value?`bg-primary text-white`:`bg-surface text-text-muted`}`,children:n.label},n.value))}),(0,j.jsx)(`h2`,{className:`mt-6 mb-2 text-sm font-semibold text-text-muted`,children:`Tamanho da letra`}),(0,j.jsxs)(`div`,{className:`flex items-center gap-3`,children:[(0,j.jsx)(`button`,{onClick:()=>r(n-.1),className:`h-10 w-10 rounded-full bg-surface text-sm font-medium text-text active:scale-95`,children:`A-`}),(0,j.jsxs)(`span`,{className:`text-sm text-text-muted`,children:[Math.round(n*100),`%`]}),(0,j.jsx)(`button`,{onClick:()=>r(n+.1),className:`h-10 w-10 rounded-full bg-surface text-sm font-medium text-text active:scale-95`,children:`A+`})]}),(0,j.jsx)(`h2`,{className:`mt-6 mb-2 text-sm font-semibold text-text-muted`,children:`Sobre`}),(0,j.jsx)(`p`,{className:`text-sm text-text-muted`,children:`Minha Igreja reúne, em um só lugar no celular, os cadernos de hinos usados nos cultos e reuniões e a Bíblia — começando pela pasta do Círculo de Oração JD América. Funciona offline, como um app de igreja.`})]})]})}function Vr(){let[e,t]=(0,x.useState)(``),n=Qn(e=>e.lastReadBible),r=n?ur[n.book]:null,{vt:i,nt:a}=(0,x.useMemo)(()=>{let t=e.trim().toLowerCase(),n=t?lr.filter(e=>e.name.toLowerCase().includes(t)):lr;return{vt:n.filter(e=>e.testament===`VT`),nt:n.filter(e=>e.testament===`NT`)}},[e]);return(0,j.jsxs)(`div`,{children:[(0,j.jsx)(vr,{title:`Bíblia`,subtitle:`Almeida Atualizada`}),(0,j.jsx)(`div`,{className:`px-4 pt-4`,children:(0,j.jsx)(kr,{value:e,onChange:t,placeholder:`Buscar livro…`})}),r&&n&&!e&&(0,j.jsx)(`div`,{className:`px-4 pt-4`,children:(0,j.jsxs)(jn,{to:`/biblia/${n.book}/${n.chapter}`,className:`flex items-center gap-3 rounded-2xl bg-primary-soft px-4 py-3 transition active:scale-[0.98]`,children:[(0,j.jsx)(`span`,{className:`text-2xl`,children:`📖`}),(0,j.jsxs)(`div`,{className:`min-w-0 flex-1`,children:[(0,j.jsx)(`p`,{className:`text-xs font-medium text-primary`,children:`Continuar lendo`}),(0,j.jsxs)(`p`,{className:`truncate font-semibold text-text`,children:[r.name,` `,n.chapter]})]}),(0,j.jsx)(`span`,{className:`text-text-muted`,children:`›`})]})}),(0,j.jsxs)(`div`,{className:`px-4 py-4`,children:[i.length>0&&(0,j.jsx)(Hr,{title:`Antigo Testamento`,books:i}),a.length>0&&(0,j.jsx)(Hr,{title:`Novo Testamento`,books:a}),i.length===0&&a.length===0&&(0,j.jsx)(`p`,{className:`py-8 text-center text-sm text-text-muted`,children:`Nenhum livro encontrado`})]})]})}function Hr({title:e,books:t}){return(0,j.jsxs)(`div`,{className:`mb-6`,children:[(0,j.jsx)(`p`,{className:`mb-2 px-1 text-xs font-semibold uppercase tracking-wide text-text-muted`,children:e}),(0,j.jsx)(`div`,{className:`grid grid-cols-3 gap-2`,children:t.map(e=>(0,j.jsx)(jn,{to:`/biblia/${e.abbrev}`,className:`rounded-2xl bg-surface px-3 py-3 text-center text-sm font-medium text-text transition active:scale-[0.97]`,children:e.name},e.abbrev))})]})}function Ur(){let{book:e}=bt(),t=e?ur[e]:void 0,{data:n,loading:r,error:i}=ir(()=>sr(e),[e]);return t?(0,j.jsxs)(`div`,{children:[(0,j.jsx)(vr,{title:t.name,showBack:!0,onBack:()=>history.back()}),(0,j.jsxs)(`div`,{className:`px-4 py-4`,children:[r&&(0,j.jsx)(jr,{}),i&&(0,j.jsx)(Mr,{}),n!==null&&(0,j.jsx)(`div`,{className:`grid grid-cols-5 gap-2`,children:Array.from({length:n},(e,t)=>t+1).map(e=>(0,j.jsx)(jn,{to:`/biblia/${t.abbrev}/${e}`,className:`flex aspect-square items-center justify-center rounded-2xl bg-surface text-sm font-semibold text-text transition active:scale-[0.95]`,children:e},e))})]})]}):(0,j.jsx)(Ht,{to:`/biblia`,replace:!0})}var Wr=Jn()(Zn((e,t)=>({notes:{},setNote:(t,n)=>e(e=>({notes:{...e.notes,[t]:n}})),removeNote:t=>e(e=>{let n={...e.notes};return delete n[t],{notes:n}}),getNote:e=>t().notes[e]}),{name:`adba-app-notes`}));function Gr(){let{book:e,chapter:t}=bt(),n=gt(),r=e?ur[e]:void 0,i=Number(t),{data:a,loading:o,error:s}=ir(()=>cr(e,i),[e,i]),{data:c}=ir(()=>sr(e),[e]),l=Qn(e=>e.fontScale),u=Qn(e=>e.setFontScale),d=Qn(e=>e.setLastReadBible),{isVerseFavorite:f,toggleVerseFavorite:p}=Pr(),{getNote:m,setNote:h,removeNote:g}=Wr(),[_,v]=(0,x.useState)(null),[y,b]=(0,x.useState)(``),[ee,S]=(0,x.useState)(!1),[C,te]=(0,x.useState)(!1),ne=$n(e=>e.setNavHidden),re=(0,x.useRef)(0);(0,x.useEffect)(()=>{r&&Number.isFinite(i)&&i>0&&d({book:r.abbrev,chapter:i})},[r,i,d]),(0,x.useEffect)(()=>{v(null),S(!1)},[e,i]),(0,x.useEffect)(()=>{re.current=window.scrollY;function e(){let e=window.scrollY,t=e-re.current;Math.abs(t)<8||(t>0&&e>80?(te(!0),ne(!0)):t<0&&(te(!1),ne(!1)),re.current=e)}return window.addEventListener(`scroll`,e,{passive:!0}),()=>{window.removeEventListener(`scroll`,e),ne(!1)}},[ne]);let w=!C||_!==null;if(!r||!Number.isFinite(i)||i<1)return(0,j.jsx)(Ht,{to:`/biblia`,replace:!0});let T=r,ie=i>1,ae=c!==null&&i<c,oe=e=>`${T.abbrev}-${i}-${e}`,E=_===null?null:oe(_);function se(){E&&b(m(E)??``),S(!0)}function ce(){E&&(y.trim()?h(E,y.trim()):g(E),S(!1))}function D(){_===null||!a||navigator.clipboard?.writeText(`${a[_-1]} (${T.name} ${i}:${_})`)}function O(){_===null||!a||mr({title:`${T.name} ${i}:${_}`,text:`${a[_-1]} (${T.name} ${i}:${_})`,url:location.href})}return(0,j.jsxs)(`div`,{className:`pb-28`,children:[(0,j.jsxs)(`div`,{className:`sticky top-0 z-30 flex items-center gap-2 bg-bg px-4 pb-2 pt-4 transition-all duration-300 ease-out ${w?`translate-y-0 opacity-100`:`-translate-y-full opacity-0`}`,children:[(0,j.jsx)(`button`,{onClick:()=>n(`/biblia`),"aria-label":`Voltar`,className:`flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-surface text-text active:scale-95`,children:`←`}),(0,j.jsxs)(`div`,{className:`flex flex-1 gap-2`,children:[(0,j.jsx)(`button`,{onClick:()=>u(l-.1),className:`h-9 w-9 rounded-full bg-surface text-sm text-text active:scale-95`,children:`A-`}),(0,j.jsx)(`button`,{onClick:()=>u(l+.1),className:`h-9 w-9 rounded-full bg-surface text-sm text-text active:scale-95`,children:`A+`})]})]}),(0,j.jsxs)(`div`,{className:`px-4 py-2 text-center`,children:[(0,j.jsx)(jn,{to:`/biblia/${r.abbrev}`,className:`text-xs font-semibold uppercase tracking-widest text-text-muted`,children:r.name}),(0,j.jsx)(`p`,{className:`text-6xl font-black leading-none text-text`,children:i})]}),(0,j.jsxs)(`div`,{className:`px-4`,children:[o&&(0,j.jsx)(jr,{}),s&&(0,j.jsx)(Mr,{}),a&&(0,j.jsx)(`p`,{className:`leading-loose text-text`,style:{fontSize:`${l}rem`,fontFamily:`Georgia, "Times New Roman", serif`},children:a.map((e,t)=>{let n=t+1,r=oe(n),i=f(r),a=!!m(r),o=_===n;return(0,j.jsxs)(`span`,{onClick:()=>v(o?null:n),className:`cursor-pointer rounded transition ${i?`bg-accent/25`:``} ${o?`ring-2 ring-primary`:``}`,children:[(0,j.jsxs)(`sup`,{className:`mr-1 font-sans text-[0.65em] font-bold text-primary`,children:[n,a&&`📝`]}),e,` `]},n)})})]}),_!==null&&(0,j.jsx)(`div`,{className:`fixed bottom-16 left-0 right-0 z-40 mx-auto max-w-md px-4`,children:ee?(0,j.jsxs)(`div`,{className:`rounded-2xl border border-border bg-surface p-3 shadow-lg`,children:[(0,j.jsx)(`textarea`,{autoFocus:!0,value:y,onChange:e=>b(e.target.value),placeholder:`Anotação sobre ${r.name} ${i}:${_}…`,className:`h-20 w-full resize-none rounded-xl border border-border bg-bg p-2 text-sm text-text outline-none`}),(0,j.jsxs)(`div`,{className:`mt-2 flex justify-end gap-2`,children:[(0,j.jsx)(`button`,{onClick:()=>S(!1),className:`rounded-full px-4 py-1.5 text-sm font-medium text-text-muted active:scale-95`,children:`Cancelar`}),(0,j.jsx)(`button`,{onClick:ce,className:`rounded-full bg-primary px-4 py-1.5 text-sm font-medium text-white active:scale-95`,children:`Salvar`})]})]}):(0,j.jsxs)(`div`,{className:`flex items-center justify-around rounded-2xl border border-border bg-surface py-2 shadow-lg`,children:[(0,j.jsxs)(`button`,{onClick:()=>E&&p(E),className:`flex flex-col items-center gap-0.5 px-2 text-[11px] font-medium text-text active:scale-95`,children:[(0,j.jsx)(`span`,{className:`text-lg`,children:E&&f(E)?`🖍️`:`🖊️`}),`Marcar`]}),(0,j.jsxs)(`button`,{onClick:se,className:`flex flex-col items-center gap-0.5 px-2 text-[11px] font-medium text-text active:scale-95`,children:[(0,j.jsx)(`span`,{className:`text-lg`,children:`📝`}),`Anotar`]}),(0,j.jsxs)(`button`,{onClick:D,className:`flex flex-col items-center gap-0.5 px-2 text-[11px] font-medium text-text active:scale-95`,children:[(0,j.jsx)(`span`,{className:`text-lg`,children:`📋`}),`Copiar`]}),(0,j.jsxs)(`button`,{onClick:O,className:`flex flex-col items-center gap-0.5 px-2 text-[11px] font-medium text-text active:scale-95`,children:[(0,j.jsx)(`span`,{className:`text-lg`,children:`📤`}),`Compartilhar`]})]})}),(0,j.jsx)(`div`,{className:`fixed bottom-16 left-0 right-0 z-30 mx-auto max-w-md px-4 pb-3 transition-all duration-300 ease-out ${C&&_===null?`translate-y-24 opacity-0`:`translate-y-0 opacity-100`}`,style:{display:_===null?void 0:`none`},children:(0,j.jsxs)(`div`,{className:`flex items-center gap-1 rounded-full border border-border bg-surface p-1.5 shadow-lg`,children:[ie?(0,j.jsx)(jn,{to:`/biblia/${r.abbrev}/${i-1}`,className:`flex h-9 w-9 items-center justify-center rounded-full text-text active:scale-95`,"aria-label":`Capítulo anterior`,children:`‹`}):(0,j.jsx)(`span`,{className:`h-9 w-9`}),(0,j.jsxs)(jn,{to:`/biblia/${r.abbrev}`,className:`flex-1 truncate rounded-full py-2 text-center text-sm font-medium text-text`,children:[r.name,` `,i]}),ae?(0,j.jsx)(jn,{to:`/biblia/${r.abbrev}/${i+1}`,className:`flex h-9 w-9 items-center justify-center rounded-full text-text active:scale-95`,"aria-label":`Próximo capítulo`,children:`›`}):(0,j.jsx)(`span`,{className:`h-9 w-9`})]})})]})}function Kr(){return(0,j.jsxs)(`div`,{children:[(0,j.jsx)(vr,{title:`Planos`}),(0,j.jsx)(`div`,{className:`px-4 py-4`,children:(0,j.jsx)(Nr,{icon:`✅`,title:`Em breve`,description:`Os planos de leitura e estudo vão aparecer aqui.`})})]})}function qr(){return(0,j.jsxs)(`div`,{children:[(0,j.jsx)(vr,{title:`Descubra`}),(0,j.jsx)(`div`,{className:`px-4 py-4`,children:(0,j.jsx)(Nr,{icon:`🔎`,title:`Em breve`,description:`Conteúdos e recursos para descobrir vão aparecer aqui.`})})]})}function Jr(){return rr(),(0,j.jsxs)(Gt,{children:[(0,j.jsxs)(A,{element:(0,j.jsx)(nr,{}),children:[(0,j.jsx)(A,{path:`/`,element:(0,j.jsx)(gr,{})}),(0,j.jsx)(A,{path:`/hinos`,element:(0,j.jsx)(Or,{})}),(0,j.jsx)(A,{path:`/harpa`,element:(0,j.jsx)(Fr,{hymnalId:`harpa`,basePath:`/harpa`})}),(0,j.jsx)(A,{path:`/harpa/:id`,element:(0,j.jsx)(Lr,{hymnalId:`harpa`,basePath:`/harpa`})}),(0,j.jsx)(A,{path:`/preciosas`,element:(0,j.jsx)(Fr,{hymnalId:`preciosas`,basePath:`/preciosas`})}),(0,j.jsx)(A,{path:`/preciosas/:id`,element:(0,j.jsx)(Lr,{hymnalId:`preciosas`,basePath:`/preciosas`})}),(0,j.jsx)(A,{path:`/geracao-life`,element:(0,j.jsx)(Fr,{hymnalId:`geracaoLife`,basePath:`/geracao-life`})}),(0,j.jsx)(A,{path:`/geracao-life/:id`,element:(0,j.jsx)(Lr,{hymnalId:`geracaoLife`,basePath:`/geracao-life`})}),(0,j.jsx)(A,{path:`/biblia`,element:(0,j.jsx)(Vr,{})}),(0,j.jsx)(A,{path:`/biblia/:book`,element:(0,j.jsx)(Ur,{})}),(0,j.jsx)(A,{path:`/biblia/:book/:chapter`,element:(0,j.jsx)(Gr,{})}),(0,j.jsx)(A,{path:`/planos`,element:(0,j.jsx)(Kr,{})}),(0,j.jsx)(A,{path:`/descubra`,element:(0,j.jsx)(qr,{})}),(0,j.jsx)(A,{path:`/favoritos`,element:(0,j.jsx)(Rr,{})}),(0,j.jsx)(A,{path:`/configuracoes`,element:(0,j.jsx)(Br,{})})]}),(0,j.jsx)(A,{path:`*`,element:(0,j.jsx)(Ht,{to:`/`,replace:!0})})]})}(0,Hn.createRoot)(document.getElementById(`root`)).render((0,j.jsx)(x.StrictMode,{children:(0,j.jsx)(An,{children:(0,j.jsx)(Jr,{})})}));