...
Deus vai me ajudar (2x)`}],geracaoLife:[]};async function sr(e){return[...or[e]].sort((e,t)=>e.number-t.number)}async function cr(e,t){return or[e].find(e=>e.id===t)}var lr={harpa:`Harpa Cristã`,preciosas:`Preciosas`,geracaoLife:`Geração Life`},ur={harpa:`Pasta a cadastrar`,preciosas:`Círculo de Oração · JD América`,geracaoLife:`Pasta a cadastrar`},dr={harpa:`🎵`,preciosas:`💎`,geracaoLife:`🔥`},fr={preciosas:`./preciosas-logo.jpg`},pr={harpa:`harpa`,preciosas:`preciosas`,geracaoLife:`geracao-life`},mr=[`preciosas`,`harpa`,`geracaoLife`];function hr(){let[e,t]=(0,x.useState)({});return(0,x.useEffect)(()=>{let e=!0;return Promise.all(mr.map(e=>sr(e))).then(n=>{if(!e)return;let r={};mr.forEach((e,t)=>{r[e]=n[t].length}),t(r)}),()=>{e=!1}},[]),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(ar,{title:`Pasta de Hinos`,subtitle:`Toque numa pasta para abrir`}),(0,j.jsxs)(`div`,{className:`flex flex-col items-center gap-2 px-4 pt-6 pb-2 text-center`,children:[(0,j.jsx)(ir,{size:56}),(0,j.jsx)(`h1`,{className:`text-lg font-bold text-text`,children:`Suas pastas de hinos`}),(0,j.jsx)(`p`,{className:`max-w-xs text-sm text-text-muted`,children:`O mesmo conteúdo das pastas físicas, sempre no seu bolso.`})]}),(0,j.jsx)(`div`,{className:`flex flex-col gap-3 px-4 py-4`,children:mr.map(t=>{let n=e[t],r=n===0;return(0,j.jsxs)(jn,{to:`/${pr[t]}`,className:`flex items-center gap-3 rounded-2xl border border-border bg-surface px-4 py-4 shadow-sm transition active:scale-[0.98]`,children:[fr[t]?(0,j.jsx)(`img`,{src:fr[t],alt:``,"aria-hidden":!0,className:`h-12 w-12 shrink-0 rounded-xl object-cover`}):(0,j.jsx)(`span`,{className:`flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-primary-soft text-2xl`,"aria-hidden":!0,children:dr[t]}),(0,j.jsxs)(`div`,{className:`min-w-0 flex-1`,children:[(0,j.jsx)(`p`,{className:`truncate font-semibold text-text`,children:lr[t]}),(0,j.jsx)(`p`,{className:`truncate text-xs text-text-muted`,children:ur[t]})]}),(0,j.jsx)(`span`,{className:`shrink-0 text-xs font-medium text-text-muted`,children:n===void 0?`…`:r?`em breve`:`${n} hinos`}),(0,j.jsx)(`span`,{className:`text-text-muted`,children:`›`})]},t)})})]})}function gr({value:e,onChange:t,placeholder:n=`Pesquisar…`}){return(0,j.jsxs)(`div`,{className:`flex items-center gap-2 rounded-xl border border-border bg-surface px-3 py-2.5`,children:[(0,j.jsx)(`span`,{"aria-hidden":!0,className:`text-text-muted`,children:`🔎`}),(0,j.jsx)(`input`,{value:e,onChange:e=>t(e.target.value),placeholder:n,className:`w-full bg-transparent text-sm text-text placeholder:text-text-muted focus:outline-none`}),e&&(0,j.jsx)(`button`,{onClick:()=>t(``),"aria-label":`Limpar busca`,className:`text-text-muted hover:text-text`,children:`✕`})]})}function _r({rows:e=4}){return(0,j.jsx)(`div`,{className:`flex flex-col gap-3 px-4 py-4`,"aria-busy":`true`,"aria-label":`Carregando`,children:Array.from({length:e}).map((e,t)=>(0,j.jsx)(`div`,{className:`h-24 w-full animate-pulse rounded-2xl bg-surface-alt`},t))})}function vr(){return(0,j.jsx)(`div`,{className:`flex items-center justify-center py-16`,"aria-busy":`true`,"aria-label":`Carregando`,children:(0,j.jsx)(`div`,{className:`h-8 w-8 animate-spin rounded-full border-2 border-border border-t-primary`})})}function yr({title:e=`Não foi possível carregar o conteúdo`,description:t=`Verifique sua conexão e tente novamente.`,onRetry:n}){return(0,j.jsxs)(`div`,{className:`flex flex-col items-center justify-center gap-3 px-6 py-16 text-center`,children:[(0,j.jsx)(`span`,{className:`text-4xl`,"aria-hidden":!0,children:`⚠️`}),(0,j.jsx)(`p`,{className:`font-medium text-text`,children:e}),(0,j.jsx)(`p`,{className:`text-sm text-text-muted max-w-xs`,children:t}),n&&(0,j.jsx)(`button`,{onClick:n,className:`mt-2 rounded-full bg-primary px-5 py-2 text-sm font-medium text-white active:scale-95 transition`,children:`Tentar novamente`})]})}function br({icon:e=`📭`,title:t,description:n}){return(0,j.jsxs)(`div`,{className:`flex flex-col items-center justify-center gap-2 px-6 py-16 text-center`,children:[(0,j.jsx)(`span`,{className:`text-4xl`,"aria-hidden":!0,children:e}),(0,j.jsx)(`p`,{className:`font-medium text-text`,children:t}),n&&(0,j.jsx)(`p`,{className:`text-sm text-text-muted max-w-xs`,children:n})]})}function xr(e,t=[]){let[n,r]=(0,x.useState)(null),[i,a]=(0,x.useState)(!0),[o,s]=(0,x.useState)(!1),[c,l]=(0,x.useState)(0),u=(0,x.useCallback)(()=>l(e=>e+1),[]);return(0,x.useEffect)(()=>{let t=!0;return a(!0),s(!1),e().then(e=>{t&&r(e)}).catch(()=>{t&&s(!0)}).finally(()=>{t&&a(!1)}),()=>{t=!1}},[...t,c]),{data:n,loading:i,error:o,reload:u}}var Sr=Qn()(tr((e,t)=>({hymnFavorites:[],toggleHymnFavorite:t=>e(e=>({hymnFavorites:e.hymnFavorites.includes(t)?e.hymnFavorites.filter(e=>e!==t):[...e.hymnFavorites,t]})),isHymnFavorite:e=>t().hymnFavorites.includes(e),verseFavorites:[],toggleVerseFavorite:t=>e(e=>({verseFavorites:e.verseFavorites.includes(t)?e.verseFavorites.filter(e=>e!==t):[...e.verseFavorites,t]})),isVerseFavorite:e=>t().verseFavorites.includes(e)}),{name:`adba-app-favorites`}));function Cr({hymnalId:e,basePath:t}){let{data:n,loading:r,error:i,reload:a}=xr(()=>sr(e),[e]),[o,s]=(0,x.useState)(``),{isHymnFavorite:c}=Sr(),l=(0,x.useMemo)(()=>{if(!n)return[];let e=o.trim().toLowerCase();return e?n.filter(t=>t.title.toLowerCase().includes(e)||String(t.number).includes(e)):n},[n,o]);return(0,j.jsxs)(`div`,{children:[(0,j.jsx)(ar,{title:lr[e],showBack:!0,onBack:()=>history.back()}),(0,j.jsx)(`div`,{className:`px-4 pt-4`,children:(0,j.jsx)(gr,{value:o,onChange:s,placeholder:`Buscar por número ou título…`})}),(0,j.jsxs)(`div`,{className:`px-4 py-4`,children:[r&&(0,j.jsx)(_r,{}),i&&(0,j.jsx)(yr,{onRetry:a}),n&&l.length===0&&(0,j.jsx)(br,{icon:`🎵`,title:`Nenhum hino encontrado`}),(0,j.jsx)(`div`,{className:`flex flex-col gap-2`,children:l.map(e=>(0,j.jsxs)(jn,{to:`${t}/${e.id}`,className:`flex items-center gap-3 rounded-xl border border-border bg-surface px-3 py-2.5 transition active:scale-[0.98]`,children:[(0,j.jsx)(`span`,{className:`flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-primary-soft text-sm font-bold text-primary`,children:e.number}),(0,j.jsx)(`span`,{className:`flex-1 text-sm font-medium text-text`,children:e.title}),c(e.id)&&(0,j.jsx)(`span`,{"aria-hidden":!0,children:`★`})]},e.id))})]})]})}async function wr(e){if(navigator.share)try{return await navigator.share(e),!0}catch{return!1}return navigator.clipboard&&e.url?(await navigator.clipboard.writeText(e.url),`copied`):!1}function Tr({lyrics:e}){let t=e.split(`**`);return(0,j.jsx)(j.Fragment,{children:t.map((e,t)=>t%2==1?(0,j.jsx)(`strong`,{className:`font-bold`,children:e},t):(0,j.jsx)(`span`,{children:e},t))})}function Er({hymnalId:e}){let{id:t}=yt(),{data:n,loading:r,error:i}=xr(()=>cr(e,t),[e,t]),a=nr(e=>e.fontScale),o=nr(e=>e.setFontScale),{isHymnFavorite:s,toggleHymnFavorite:c}=Sr();return(0,j.jsxs)(`div`,{children:[(0,j.jsx)(ar,{title:lr[e],showBack:!0,onBack:()=>history.back()}),r&&(0,j.jsx)(vr,{}),i&&(0,j.jsx)(yr,{}),n&&(0,j.jsxs)(`div`,{className:`px-4 py-4`,children:[(0,j.jsxs)(`div`,{className:`flex items-start justify-between gap-2`,children:[(0,j.jsxs)(`div`,{children:[(0,j.jsxs)(`p`,{className:`text-xs font-semibold uppercase tracking-wide text-primary`,children:[`Hino `,n.number]}),(0,j.jsx)(`h1`,{className:`text-xl font-bold leading-snug text-text`,children:n.title})]}),(0,j.jsx)(`button`,{onClick:()=>c(n.id),"aria-label":`Favoritar`,className:`text-2xl`,children:s(n.id)?`★`:`☆`})]}),(0,j.jsxs)(`div`,{className:`mt-3 flex items-center gap-2`,children:[(0,j.jsx)(`button`,{onClick:()=>o(a-.1),className:`h-8 w-8 rounded-full border border-border text-sm text-text active:scale-95`,children:`A-`}),(0,j.jsx)(`button`,{onClick:()=>o(a+.1),className:`h-8 w-8 rounded-full border border-border text-sm text-text active:scale-95`,children:`A+`}),(0,j.jsx)(`button`,{onClick:()=>wr({title:n.title,text:n.lyrics.replace(/\*\*/g,``),url:location.href}),className:`ml-auto rounded-full border border-border px-4 py-1.5 text-sm font-medium text-text active:scale-95`,children:`📤 Compartilhar`})]}),(0,j.jsx)(`p`,{className:`mt-5 whitespace-pre-line leading-relaxed text-text`,style:{fontSize:`${a}rem`},children:(0,j.jsx)(Tr,{lyrics:n.lyrics})})]})]})}function Dr(){let{hymnFavorites:e}=Sr(),[t,n]=(0,x.useState)(null);return(0,x.useEffect)(()=>{let t=!0;return Promise.all(mr.map(e=>sr(e))).then(r=>{if(!t)return;let i=r.flat();n(i.filter(t=>e.includes(t.id)))}),()=>{t=!1}},[e]),(0,j.jsxs)(`div`,{children:[(0,j.jsx)(ar,{title:`Favoritos`,subtitle:`Seus hinos marcados com ★`}),(0,j.jsxs)(`div`,{className:`px-4 py-4`,children:[t===null&&(0,j.jsx)(_r,{}),t&&t.length===0&&(0,j.jsx)(br,{icon:`⭐`,title:`Nenhum favorito ainda`,description:`Toque na estrela dentro de um hino para guardá-lo aqui.`}),t&&t.length>0&&(0,j.jsx)(`div`,{className:`flex flex-col gap-2`,children:t.map(e=>(0,j.jsxs)(jn,{to:`/${pr[e.hymnal]}/${e.id}`,className:`flex items-center gap-3 rounded-xl border border-border bg-surface px-3 py-2.5 transition active:scale-[0.98]`,children:[(0,j.jsx)(`span`,{className:`flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-primary-soft text-sm font-bold text-primary`,children:e.number}),(0,j.jsxs)(`div`,{className:`min-w-0 flex-1`,children:[(0,j.jsx)(`p`,{className:`truncate text-sm font-medium text-text`,children:e.title}),(0,j.jsx)(`p`,{className:`truncate text-xs text-text-muted`,children:lr[e.hymnal]})]}),(0,j.jsx)(`span`,{"aria-hidden":!0,children:`★`})]},e.id))})]})]})}var Or=[{value:`light`,label:`Claro`},{value:`dark`,label:`Escuro`},{value:`system`,label:`Seguir sistema`}];function kr(){let e=nr(e=>e.theme),t=nr(e=>e.setTheme),n=nr(e=>e.fontScale),r=nr(e=>e.setFontScale);return(0,j.jsxs)(`div`,{children:[(0,j.jsx)(ar,{title:`Configurações`}),(0,j.jsxs)(`div`,{className:`px-4 py-4`,children:[(0,j.jsx)(`h2`,{className:`mb-2 text-sm font-semibold text-text-muted`,children:`Tema`}),(0,j.jsx)(`div`,{className:`flex gap-2`,children:Or.map(n=>(0,j.jsx)(`button`,{onClick:()=>t(n.value),className:`flex-1 rounded-xl border py-2.5 text-sm font-medium transition ${e===n.value?`border-primary bg-primary-soft text-primary`:`border-border text-text-muted`}`,children:n.label},n.value))}),(0,j.jsx)(`h2`,{className:`mt-6 mb-2 text-sm font-semibold text-text-muted`,children:`Tamanho da letra`}),(0,j.jsxs)(`div`,{className:`flex items-center gap-3`,children:[(0,j.jsx)(`button`,{onClick:()=>r(n-.1),className:`h-10 w-10 rounded-full border border-border text-sm font-medium text-text active:scale-95`,children:`A-`}),(0,j.jsxs)(`span`,{className:`text-sm text-text-muted`,children:[Math.round(n*100),`%`]}),(0,j.jsx)(`button`,{onClick:()=>r(n+.1),className:`h-10 w-10 rounded-full border border-border text-sm font-medium text-text active:scale-95`,children:`A+`})]}),(0,j.jsx)(`h2`,{className:`mt-6 mb-2 text-sm font-semibold text-text-muted`,children:`Sobre`}),(0,j.jsx)(`p`,{className:`text-sm text-text-muted`,children:`Pasta de Hinos reúne, em um só lugar no celular, os cadernos de hinos usados nos cultos e reuniões — começando pela pasta do Círculo de Oração JD América. Funciona offline, como uma pasta física digital.`})]})]})}var Ar=[{abbrev:`gn`,name:`Gênesis`,testament:`VT`},{abbrev:`ex`,name:`Êxodo`,testament:`VT`},{abbrev:`lv`,name:`Levítico`,testament:`VT`},{abbrev:`nm`,name:`Números`,testament:`VT`},{abbrev:`dt`,name:`Deuteronômio`,testament:`VT`},{abbrev:`js`,name:`Josué`,testament:`VT`},{abbrev:`jz`,name:`Juízes`,testament:`VT`},{abbrev:`rt`,name:`Rute`,testament:`VT`},{abbrev:`1sm`,name:`1 Samuel`,testament:`VT`},{abbrev:`2sm`,name:`2 Samuel`,testament:`VT`},{abbrev:`1rs`,name:`1 Reis`,testament:`VT`},{abbrev:`2rs`,name:`2 Reis`,testament:`VT`},{abbrev:`1cr`,name:`1 Crônicas`,testament:`VT`},{abbrev:`2cr`,name:`2 Crônicas`,testament:`VT`},{abbrev:`ed`,name:`Esdras`,testament:`VT`},{abbrev:`ne`,name:`Neemias`,testament:`VT`},{abbrev:`et`,name:`Ester`,testament:`VT`},{abbrev:`jó`,name:`Jó`,testament:`VT`},{abbrev:`sl`,name:`Salmos`,testament:`VT`},{abbrev:`pv`,name:`Provérbios`,testament:`VT`},{abbrev:`ec`,name:`Eclesiastes`,testament:`VT`},{abbrev:`ct`,name:`Cânticos`,testament:`VT`},{abbrev:`is`,name:`Isaías`,testament:`VT`},{abbrev:`jr`,name:`Jeremias`,testament:`VT`},{abbrev:`lm`,name:`Lamentações`,testament:`VT`},{abbrev:`ez`,name:`Ezequiel`,testament:`VT`},{abbrev:`dn`,name:`Daniel`,testament:`VT`},{abbrev:`os`,name:`Oséias`,testament:`VT`},{abbrev:`jl`,name:`Joel`,testament:`VT`},{abbrev:`am`,name:`Amós`,testament:`VT`},{abbrev:`ob`,name:`Obadias`,testament:`VT`},{abbrev:`jn`,name:`Jonas`,testament:`VT`},{abbrev:`mq`,name:`Miquéias`,testament:`VT`},{abbrev:`na`,name:`Naum`,testament:`VT`},{abbrev:`hc`,name:`Habacuque`,testament:`VT`},{abbrev:`sf`,name:`Sofonias`,testament:`VT`},{abbrev:`ag`,name:`Ageu`,testament:`VT`},{abbrev:`zc`,name:`Zacarias`,testament:`VT`},{abbrev:`ml`,name:`Malaquias`,testament:`VT`},{abbrev:`mt`,name:`Mateus`,testament:`NT`},{abbrev:`mc`,name:`Marcos`,testament:`NT`},{abbrev:`lc`,name:`Lucas`,testament:`NT`},{abbrev:`jo`,name:`João`,testament:`NT`},{abbrev:`atos`,name:`Atos`,testament:`NT`},{abbrev:`rm`,name:`Romanos`,testament:`NT`},{abbrev:`1co`,name:`1 Coríntios`,testament:`NT`},{abbrev:`2co`,name:`2 Coríntios`,testament:`NT`},{abbrev:`gl`,name:`Gálatas`,testament:`NT`},{abbrev:`ef`,name:`Efésios`,testament:`NT`},{abbrev:`fp`,name:`Filipenses`,testament:`NT`},{abbrev:`cl`,name:`Colossenses`,testament:`NT`},{abbrev:`1ts`,name:`1 Tessalonicenses`,testament:`NT`},{abbrev:`2ts`,name:`2 Tessalonicenses`,testament:`NT`},{abbrev:`1tm`,name:`1 Timóteo`,testament:`NT`},{abbrev:`2tm`,name:`2 Timóteo`,testament:`NT`},{abbrev:`tt`,name:`Tito`,testament:`NT`},{abbrev:`fm`,name:`Filemom`,testament:`NT`},{abbrev:`hb`,name:`Hebreus`,testament:`NT`},{abbrev:`tg`,name:`Tiago`,testament:`NT`},{abbrev:`1pe`,name:`1 Pedro`,testament:`NT`},{abbrev:`2pe`,name:`2 Pedro`,testament:`NT`},{abbrev:`1jo`,name:`1 João`,testament:`NT`},{abbrev:`2jo`,name:`2 João`,testament:`NT`},{abbrev:`3jo`,name:`3 João`,testament:`NT`},{abbrev:`jd`,name:`Judas`,testament:`NT`},{abbrev:`ap`,name:`Apocalipse`,testament:`NT`}],jr=Object.fromEntries(Ar.map(e=>[e.abbrev,e]));function Mr(){let[e,t]=(0,x.useState)(``),{vt:n,nt:r}=(0,x.useMemo)(()=>{let t=e.trim().toLowerCase(),n=t?Ar.filter(e=>e.name.toLowerCase().includes(t)):Ar;return{vt:n.filter(e=>e.testament===`VT`),nt:n.filter(e=>e.testament===`NT`)}},[e]);return(0,j.jsxs)(`div`,{children:[(0,j.jsx)(ar,{title:`Bíblia`,subtitle:`Almeida Atualizada`}),(0,j.jsx)(`div`,{className:`px-4 pt-4`,children:(0,j.jsx)(gr,{value:e,onChange:t,placeholder:`Buscar livro…`})}),(0,j.jsxs)(`div`,{className:`px-4 py-4`,children:[n.length>0&&(0,j.jsx)(Nr,{title:`Antigo Testamento`,books:n}),r.length>0&&(0,j.jsx)(Nr,{title:`Novo Testamento`,books:r}),n.length===0&&r.length===0&&(0,j.jsx)(`p`,{className:`py-8 text-center text-sm text-text-muted`,children:`Nenhum livro encontrado`})]})]})}function Nr({title:e,books:t}){return(0,j.jsxs)(`div`,{className:`mb-6`,children:[(0,j.jsx)(`p`,{className:`mb-2 px-1 text-xs font-semibold uppercase tracking-wide text-text-muted`,children:e}),(0,j.jsx)(`div`,{className:`grid grid-cols-3 gap-2`,children:t.map(e=>(0,j.jsx)(jn,{to:`/biblia/${e.abbrev}`,className:`rounded-xl border border-border bg-surface px-3 py-3 text-center text-sm font-medium text-text transition active:scale-[0.97]`,children:e.name},e.abbrev))})]})}var Pr=null;function Fr(){return Pr||=fetch(`./bible/aa.json`).then(e=>e.json()),Pr}async function Ir(e){let t=(await Fr()).find(t=>t.abbrev===e);return t?t.chapters.length:0}async function Lr(e,t){let n=(await Fr()).find(t=>t.abbrev===e);return n?n.chapters[t-1]??[]:[]}function Rr(){let{book:e}=yt(),t=e?jr[e]:void 0,{data:n,loading:r,error:i}=xr(()=>Ir(e),[e]);return t?(0,j.jsxs)(`div`,{children:[(0,j.jsx)(ar,{title:t.name,showBack:!0,onBack:()=>history.back()}),(0,j.jsxs)(`div`,{className:`px-4 py-4`,children:[r&&(0,j.jsx)(vr,{}),i&&(0,j.jsx)(yr,{}),n!==null&&(0,j.jsx)(`div`,{className:`grid grid-cols-5 gap-2`,children:Array.from({length:n},(e,t)=>t+1).map(e=>(0,j.jsx)(jn,{to:`/biblia/${t.abbrev}/${e}`,className:`flex aspect-square items-center justify-center rounded-xl border border-border bg-surface text-sm font-semibold text-text transition active:scale-[0.95]`,children:e},e))})]})]}):(0,j.jsx)(Vt,{to:`/biblia`,replace:!0})}function zr(){let{book:e,chapter:t}=yt(),n=ht(),r=e?jr[e]:void 0,i=Number(t),{data:a,loading:o,error:s}=xr(()=>Lr(e,i),[e,i]),{data:c}=xr(()=>Ir(e),[e]),l=nr(e=>e.fontScale),u=nr(e=>e.setFontScale);if(!r||!Number.isFinite(i)||i<1)return(0,j.jsx)(Vt,{to:`/biblia`,replace:!0});let d=i>1,f=c!==null&&i<c;return(0,j.jsxs)(`div`,{children:[(0,j.jsx)(ar,{title:`${r.name} ${i}`,showBack:!0,onBack:()=>n(`/biblia/${r.abbrev}`)}),(0,j.jsxs)(`div`,{className:`px-4 py-4`,children:[(0,j.jsxs)(`div`,{className:`mb-4 flex items-center gap-2`,children:[(0,j.jsx)(`button`,{onClick:()=>u(l-.1),className:`h-8 w-8 rounded-full border border-border text-sm text-text active:scale-95`,children:`A-`}),(0,j.jsx)(`button`,{onClick:()=>u(l+.1),className:`h-8 w-8 rounded-full border border-border text-sm text-text active:scale-95`,children:`A+`}),(0,j.jsx)(`button`,{onClick:()=>wr({title:`${r.name} ${i}`,text:(a??[]).map((e,t)=>`${t+1}. ${e}`).join(`
`),url:location.href}),className:`ml-auto rounded-full border border-border px-4 py-1.5 text-sm font-medium text-text active:scale-95`,children:`📤 Compartilhar`})]}),o&&(0,j.jsx)(vr,{}),s&&(0,j.jsx)(yr,{}),a&&(0,j.jsx)(`p`,{className:`leading-loose text-text`,style:{fontSize:`${l}rem`,fontFamily:`Georgia, "Times New Roman", serif`},children:a.map((e,t)=>(0,j.jsxs)(`span`,{children:[(0,j.jsx)(`sup`,{className:`mr-1 font-sans text-[0.65em] font-bold text-primary`,children:t+1}),e,` `]},t))}),(0,j.jsxs)(`div`,{className:`mt-8 flex items-center justify-between gap-3 border-t border-border pt-4`,children:[d?(0,j.jsxs)(jn,{to:`/biblia/${r.abbrev}/${i-1}`,className:`flex-1 rounded-xl border border-border bg-surface px-4 py-3 text-center text-sm font-medium text-text active:scale-[0.97]`,children:[`← Capítulo `,i-1]}):(0,j.jsx)(`div`,{className:`flex-1`}),f?(0,j.jsxs)(jn,{to:`/biblia/${r.abbrev}/${i+1}`,className:`flex-1 rounded-xl border border-border bg-surface px-4 py-3 text-center text-sm font-medium text-text active:scale-[0.97]`,children:[`Capítulo `,i+1,` →`]}):(0,j.jsx)(`div`,{className:`flex-1`})]})]})]})}function Br(){return rr(),(0,j.jsxs)(Gt,{children:[(0,j.jsxs)(Ut,{element:(0,j.jsx)(Kn,{}),children:[(0,j.jsx)(Ut,{path:`/`,element:(0,j.jsx)(hr,{})}),(0,j.jsx)(Ut,{path:`/harpa`,element:(0,j.jsx)(Cr,{hymnalId:`harpa`,basePath:`/harpa`})}),(0,j.jsx)(Ut,{path:`/harpa/:id`,element:(0,j.jsx)(Er,{hymnalId:`harpa`})}),(0,j.jsx)(Ut,{path:`/preciosas`,element:(0,j.jsx)(Cr,{hymnalId:`preciosas`,basePath:`/preciosas`})}),(0,j.jsx)(Ut,{path:`/preciosas/:id`,element:(0,j.jsx)(Er,{hymnalId:`preciosas`})}),(0,j.jsx)(Ut,{path:`/geracao-life`,element:(0,j.jsx)(Cr,{hymnalId:`geracaoLife`,basePath:`/geracao-life`})}),(0,j.jsx)(Ut,{path:`/geracao-life/:id`,element:(0,j.jsx)(Er,{hymnalId:`geracaoLife`})}),(0,j.jsx)(Ut,{path:`/biblia`,element:(0,j.jsx)(Mr,{})}),(0,j.jsx)(Ut,{path:`/biblia/:book`,element:(0,j.jsx)(Rr,{})}),(0,j.jsx)(Ut,{path:`/biblia/:book/:chapter`,element:(0,j.jsx)(zr,{})}),(0,j.jsx)(Ut,{path:`/favoritos`,element:(0,j.jsx)(Dr,{})}),(0,j.jsx)(Ut,{path:`/configuracoes`,element:(0,j.jsx)(kr,{})})]}),(0,j.jsx)(Ut,{path:`*`,element:(0,j.jsx)(Vt,{to:`/`,replace:!0})})]})}(0,Hn.createRoot)(document.getElementById(`root`)).render((0,j.jsx)(x.StrictMode,{children:(0,j.jsx)(An,{children:(0,j.jsx)(Br,{})})}));